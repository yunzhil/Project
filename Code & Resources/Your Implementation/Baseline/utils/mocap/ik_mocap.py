...
# def calibration_mocap(cluster_use = True):
#     """ Align frames of body segments w.r.t. the mocap frame (so all joint angles during static trial are 0's)
...
def get_all_ja_mocap(cal_orientation, mocap_orientation, cluster_use = True):
    ...
    mocap_ja['ankle_adduction_l']   = constant_common.JA_SIGN['ankle_angle_l']*temp_ankle_l[:, 0]
    mocap_ja['ankle_rotation_l']    = constant_common.JA_SIGN['ankle_angle_l']*temp_ankle_l[:, 1]
    mocap_ja['ankle_flexion_l']    = constant_common.JA_SIGN['ankle_angle_l']*temp_ankle_l[:, 2]
    ...
    mocap_ja['ankle_adduction_r']   = constant_common.JA_SIGN['ankle_angle_r']*temp_ankle_r[:, 0]
    mocap_ja['ankle_rotation_r']    = constant_common.JA_SIGN['ankle_angle_r']*temp_ankle_r[:, 1]
    mocap_ja['ankle_flexion_r']    = constant_common.JA_SIGN['ankle_angle_r']*temp_ankle_r[:, 2]
